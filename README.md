...
### Пользовательские роли ###
  ...
  - Неавторизованные пользователи могут:
     1. создать аккаунт;
     2. просматривать рецепты на главной странице;
  ...
  - Авторизованные пользователи могут:
     ...
     10. работать с персональным списком покупок: добавлять/удалять **любые** рецепты, выгружать файл с количеством необходимых ингридиентов для рецептов из списка покупок;
...
* запрос отклонен: статус 404 - рецепт не найдено
```python
{
  "detail": "Рецепт не найдено."
}
```
